...
# ╔═╡ cc91ec5b-540a-46cd-bc6f-735d9fd1f52d
xcoords[500]

# ╔═╡ 59428849-e16e-446d-a132-2e6d8e291cbe
function f(x, y)
	if 47.5 < x < 52.5
		return 1.0
	end
...
# ╔═╡ 92bb1796-b2a0-4282-b9ba-538c5054a70a
begin
	xx = LinRange(-5, 5, 100)
	yy = LinRange(-5, 5, 100)
end

# ╔═╡ b24d34fe-c458-445d-8a9d-16e18b02e6e2
ycoords
...
git-tree-sha1 = "3d2767b42719417d1c36d21b86b261c54dab70e5"
